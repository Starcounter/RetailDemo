...
curl 'http://aardvark:3000/transfer?f=1001&t=2001&x=1000'
curl 'http://aardvark:3000/balance/1001'
curl 'http://aardvark:3000/balance/2001'
curl 'http://aardvark:3000/transfer?f=2001&t=1001&x=1000'
curl 'http://aardvark:3000/balance/1001'
curl 'http://aardvark:3000/balance/2001'
